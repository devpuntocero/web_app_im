<%@ Page Title="" Language="C#" MasterPageFile="~/im.Master" AutoEventWireup="true" CodeBehind="ctrl_habilidad_matematica.aspx.cs" Inherits="web_app_im.material.mediasuperior.habilidad_matematica.ctrl_habilidad_matematica" %>
                                            ...
                                            <ul class="nav navbar-nav text-left">
                                                <li>
                                                    <div id="div_resumen" runat="server">
                                                        <asp:LinkButton CssClass="buttonClass" ID="lkb_tema1" runat="server" Text="Tema 1. Series espaciales"></asp:LinkButton><br />
                                                        <asp:LinkButton CssClass="buttonClass" ID="lkb_tema2" runat="server" Text="Tema 2. Series numéricas"></asp:LinkButton><br />
                                                        <asp:LinkButton CssClass="buttonClass" ID="lkb_tema3" runat="server" Text="Tema 3. Geometría espacial"></asp:LinkButton><br />
